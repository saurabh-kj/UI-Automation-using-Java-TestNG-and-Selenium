...
public class OrdersPF {
    @FindBy(xpath = "(//img)[6] | //body/div[@id='__next']/div[@class='headerstyle__HeaderWrap-sc-4peca5-0 hkEGYg']/div[@class='container']/div[@class='contentWrap']/div[@class='userWrap']/div[@class='loginWrapper']/span[@class='arroWIcon']/div/img[1]")
...
//----------------------------------Cash on dilivery-----------------------------------//
    ...
    @FindBy(xpath = "//h2[normalize-space()='Volamena Lip Hydration Balm, 10ml'] | //h2[normalize-space()='INLIFE Face Cream2']")
    ...
    @FindBy(xpath = "//button[@class='totalsSummary-proceed-WrG']")
    WebElement proceed;

    @FindBy(xpath = "//*[@class='checkout-paymeny_label-10k ']")
    WebElement cash_on_delivery;

    @FindBy(xpath = "//button[@class='checkout-placeOrderBtn-2rA'] | //*[normalize-space()='Place Order']")

    WebElement place_order;

    WebDriver driver;

    public OrdersPF(WebDriver driver) {
        this.driver = driver;
