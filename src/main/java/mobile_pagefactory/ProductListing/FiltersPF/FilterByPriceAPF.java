...
public class FilterByPriceAPF {
    ...
    @FindBy(xpath = "//button[@class='FilterModalstyle__StyledOption-sc-17rh6bx-4 fhPppg']//input[@id='10000-20000'] | (//input[@id='1000-2000'])[1]")
    ...
    public FilterByPriceAPF(AppiumDriver driver) {
        super();
        this.driver = driver;
