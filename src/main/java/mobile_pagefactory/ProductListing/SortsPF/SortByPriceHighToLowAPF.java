...
public class SortByPriceHighToLowAPF {
    //-------------Login-----------------//
    ...
    @FindBy(xpath = "//div[@class='mobileSort']//label[@for='Price: High to Low'][normalize-space()='Price: High to Low']//span[@class='checkmark']")
    ...
    public SortByPriceHighToLowAPF(AppiumDriver driver) {
        super();
        this.driver = driver;
