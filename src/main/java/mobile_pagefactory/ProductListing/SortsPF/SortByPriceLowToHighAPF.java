...
public class SortByPriceLowToHighAPF {
    //-------------Login-----------------//
    ...
    @FindBy(xpath = "//div[@class='mobileSort']//label[@for='Price: Low to High'][normalize-space()='Price: Low to High']//span[@class='checkmark']")
    WebElement lotohigh;
    ...
    public SortByPriceLowToHighAPF(AppiumDriver driver) {
        super();
        this.driver = driver;
