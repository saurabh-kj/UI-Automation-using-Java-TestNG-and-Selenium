...
public class SortByAlphabeticallyZtoAAPF {
    //-------------Login-----------------//
    ...
    @FindBy(xpath = "//div[@class='mobileSort']//label[@for='Alphabetically: Z-A'][normalize-space()='Alphabetically: Z-A']//span[@class='checkmark']")
    ...
    public SortByAlphabeticallyZtoAAPF(AppiumDriver driver) {
        super();
        this.driver = driver;
