...
import mobile_pagefactory.ProductListing.SortsPF.SortByPriceLowToHighAPF;
...
public class SortByPriceLowToHigh {
    ...
    SortByPriceLowToHighAPF sortByPriceLowToHigh;
    LoginWebPF login;
    CartPageAPF Cart;
...
//        this.driver = (AppiumDriver) baseClass.getDriver();
        ...
        sortByPriceLowToHigh = new SortByPriceLowToHighAPF(driver);
...
//        Cart.clickOnVerifyNow();
    ...
    public void SortByDiscount() throws InterruptedException, FileNotFoundException {
        ...
        getTest().log(Status.PASS, "Test Case is to sort products on the basis of price low to high");
        sortByPriceLowToHigh.Men();
        getTest().log(Status.PASS, "Clicking on mens business module");
        sortByPriceLowToHigh.Sort();
        getTest().log(Status.PASS, "Clicking on sorting option");
        sortByPriceLowToHigh.LowToHigh();
        getTest().log(Status.PASS, "Selecting discount low to high");
    }
