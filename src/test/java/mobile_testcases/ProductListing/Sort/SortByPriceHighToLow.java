...
import mobile_pagefactory.ProductListing.SortsPF.SortByPriceHighToLowAPF;
...
public class SortByPriceHighToLow {
    ...
    SortByPriceHighToLowAPF sortByPriceHighToLow;
    LoginWebPF login;
    CartPageAPF Cart;
...
//        this.driver = (AppiumDriver) baseClass.getDriver();
        ...
        sortByPriceHighToLow = new SortByPriceHighToLowAPF(driver);
...
//        Cart.clickOnVerifyNow();
    ...
    public void SortByDiscount() throws InterruptedException, FileNotFoundException {
        ...
        getTest().log(Status.PASS, "Test Case is to sort products on the basis of price high to low");
        sortByPriceHighToLow.Men();
        getTest().log(Status.PASS, "Clicking on mens business module");
        sortByPriceHighToLow.Sort();
        getTest().log(Status.PASS, "Clicking on sorting option");
        sortByPriceHighToLow.HighToLow();
        getTest().log(Status.PASS, "Selecting discount high to low");
    }
