...
import mobile_pagefactory.ProductListing.SortsPF.SortByRelevanceAPF;
...
public class SortByRelevance {
    ...
    SortByRelevanceAPF sortByRelevance;
    LoginWebPF login;
    CartPageAPF Cart;
...
//        this.driver = (AppiumDriver) baseClass.getDriver();
        ...
        sortByRelevance = new SortByRelevanceAPF(driver);
...
//        Cart.clickOnVerifyNow();
    ...
    public void SortByRelevance() throws InterruptedException, FileNotFoundException {
        ...
        getTest().log(Status.PASS, "Test Case is to sort products on the basis of relevance");
        sortByRelevance.Men();
        ...
        getTest().log(Status.PASS, "Selecting Relevance option");
    }
}
