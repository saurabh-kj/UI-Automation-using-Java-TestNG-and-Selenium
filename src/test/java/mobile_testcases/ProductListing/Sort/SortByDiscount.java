...
import mobile_pagefactory.ProductListing.SortsPF.SortByDiscountAPF;
...
public class SortByDiscount {
    ...
    SortByDiscountAPF sortByDiscount;
    LoginWebPF login;
    CartPageAPF Cart;
...
//        this.driver = (AppiumDriver) baseClass.getDriver();
        ...
        sortByDiscount = new SortByDiscountAPF(driver);
...
//        Cart.clickOnVerifyNow();
    ...
    public void SortByDiscount() throws InterruptedException, FileNotFoundException {
        ...
        getTest().log(Status.PASS, "Test Case is to sort products on the basis of discount");
        sortByDiscount.Men();
        ...
        getTest().log(Status.PASS, "Selecting discount option");
    }
